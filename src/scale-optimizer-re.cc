...
TH1D* getHisto_data(TTreeReader& reader, double start, double end, int ncalo_, int nxtal_){
  ...
  TTreeReaderArray<short>        xtal_Index    (reader , "xtal_Index"    );
  TTreeReaderArray<float>       xtal_energy   (reader , "xtal_energy"   ); //
...
results scanScale(TTreeReader& rdata, TTreeReader& rmc, Dtuple& ddata , Dtuple& dmc , int ncalo, int nxtal, double range1, double range2,
  ...
  TTreeReaderArray<short>        dxtal_Index    (rdata , "xtal_Index"     );
  TTreeReaderArray<float>        dxtal_energy   (rdata , "xtal_energy"    );
